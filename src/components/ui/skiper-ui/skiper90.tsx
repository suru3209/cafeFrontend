...
export { Skiper90, SkiperGradiantCard, GradiantCardBody, GradiantCardTitle };
...
const SkiperGradiantCard = ({
  ...
  return (
    <div
      className="group relative transform-gpu overflow-hidden rounded-[20px] bg-white/5 p-1 transition-transform hover:scale-[1.01] active:scale-90 backdrop-blur-sm"
      ref={parentRef}
    >
      <motion.div
        className={cn(
          ...
          "bg-[linear-gradient(135deg,rgba(59,196,242,0.3),rgba(122,105,249,0.3),rgba(242,99,120,0.3),rgba(245,131,63,0.3))] dark:bg-[linear-gradient(135deg,rgba(255,255,255,0.1),rgba(51,51,51,0.1),rgba(102,102,102,0.1),rgba(255,255,255,0.1))] dark:saturate-0"
        )}
        style={{
      ...
      />
      <div className="bg-background/60 absolute inset-px rounded-[19px] backdrop-blur-md" />
      {body && (
        <div
          className={cn(
            "gird bg-background/40 relative place-content-center overflow-hidden rounded-[15px] backdrop-blur-lg",
            className
          )}
        >
          {body}
